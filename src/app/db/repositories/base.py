...
class BaseRepository(Generic[ModelType, CreateSchemaType, UpdateSchemaType]):
    ...
    async def create(self, data: CreateSchemaType) -> APIResponse:
        ...
        """
        try:
            return await self.client.table(self.table_name).insert(data.model_dump()).execute()
    ...
    async def get(self, id: UUID) -> Optional[APIResponse]:
        ...
        """
        try:
            response = await self.client.table(self.table_name).select("*").eq("id", str(id)).execute()
    ...
    async def update(self, id: UUID, data: UpdateSchemaType) -> APIResponse:
        ...
        """
        try:
            return await self.client.table(self.table_name).update(
    ...
    async def delete(self, id: UUID) -> APIResponse:
        ...
        """
        try:
            return await self.client.table(self.table_name).delete().eq("id", str(id)).execute()
        except Exception as e:
