...
- [ ] Implement response handling
  - [ ] Set up normal response mode
  - [ ] Set up streaming response mode
...
- [ ] Implement conversation management endpoints
  ...
  - [ ] Implement GET /guest/sessions/{session_id}/threads
  - [ ] Implement DELETE /guest/sessions/{session_id}
  - [ ] Implement POST /threads/{thread_id}/suggest
...
- [ ] Implement POST /threads/{thread_id}/messages
  ...
  - [ ] Implement normal response mode
  - [ ] Implement streaming response mode
  - [ ] Add response mode configuration
...
- [ ] Implement GET /threads/{thread_id}/messages
  ...
  - [ ] Support message format for both modes
